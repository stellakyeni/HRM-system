...
@section('content')
    <main>
        <div class="container-fluid px-4 mt-3">
            <div>
                <h4>Termination Reasons
                    <h6>
                        <button type="submit" class="btn btn-success btn-sm" style="border-radius:30%"> <i
                        ...
                        <table id="datatablesSimple">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-default btn-sm" style="border-radius:35%">
